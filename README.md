...
En primera instancia, se analizó el readme del proyecto para entender cuáles eran los objetivos que habia que llevar a cabo y se instalaron todos los programas necesarios para el funcionamiento, realizando también el fork y clonación del repositorio para poder comenzar con la edición de los archivos en VSCODE. Se realizó el prototipo aproximado de como seria la página web, se definió el tema y los usuarios objetivo. Luego se inicio el código, realizando la estructura con html y se dio un pequeño avance de lo que seria el diseño con CSS. Junto a lo anterior, se definio la paleta de colores a utilizar, ademas de diseño de estructura según el tema definido.  Teniendo esto, se investigó sobre como dar la funcionalidad con los metódos de validator isValid, en primera instancia y luego con maskify. Al tener esto funcionando, validando y enmascarando el número de la tarjeta de crédito ingresada, se realizaron las pruebas unitarias, donde se fue resolviendo cada error que se presentó. A continuación, se mejoró el diseño agregando más estilos a CSS y también se realizaron ajustes en la estructura de HTML, para llegar al diseño actual. Finalmente se realizó el readme y se subió todo el código a la plataforma de Github. 
...
El objetivo principal es que el usuario pueda realizar la validación de su tarjeta de crédito para poder así, realizar la compra de alimentos a través de la página web.
...
- Primera idea de como seria el proyecto, dando enfoque a la estructura y que era lo que se quería lograr.

  
<img src="/images/img2.png" style= width:90%>

  
- Se definió la estructura y paleta de colores.
  
   
<img src="/images/img3.png" style= width:90%>
